        ...
        <table id="tblUserSettings" class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style9">
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" BorderStyle="None" ControlToValidate="txtNewPassword" Display="Dynamic" EnableTheming="True" ErrorMessage="Please follow required password format!" ValidationExpression="[a-zA-Z](?=.*?[A-Za-z])(?=.*?[0-9])(?=.*?[!*]).{8,16}$"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style12">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtNewPasswordConfirm" Display="Dynamic" ErrorMessage="Please follow required username format!" ValidationExpression="[a-zA-Z](?=.*?[A-Za-z])(?=.*?[0-9])(?=.*?[!*]).{8,16}$"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
